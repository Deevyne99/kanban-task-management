...
const BoardInput: FC<InputProps> = ({
  ...
  return (
    <input
      ...
      className={`${
        title === 'columns' || title === 'subtasks' ? 'w-[80%]' : 'w-[100%]'
      } md:w-full  w-[90%]  p-[8px] border rounded-md border-solid border-[#828FA340] font-normal focus:border-[#635FC7] focus:outline-none  ${
        error
